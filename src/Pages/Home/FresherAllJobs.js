...
const { Meta } = Card;
const FresherAllJobs = () => {
    const [fresherJobs, setFresherJobs] = useState([]);
    useEffect(() => {
        fetch('https://job-portal-server-seven.vercel.app/FresherJobs')
            .then(res => res.json())
    ...
    return (
        <div className='mb-20 mx-12'>
            <div className='text-center mb-4'>
                <p className="text-2xl lg:text-6xl font-bold text-orange-600 lg:my-12"><Wave text="Fresher All Jobs" />
                </p>
            </div>
